...
<section>
  <div class="container">
    ...
    <h3>Welcome Admin</h3>
    <ul class="choose">
        <li><a  class="sub-ex" href="add-blog.php"><span class="sprite"></span>Add Blog</a></li>
        <li><a  class="sub-ex" href="view-blog.php"><span class="sprite"></span>View Blog</a></li>
        <li><a  class="sub-ex" href="add-media.php"><span class="sprite"></span>Add Media</a></li>
        <li><a  class="sub-ex" href="view-media.php"><span class="sprite"></span>View Media</a></li>
         <li><a  class="sub-ex" href="add-events.php"><span class="sprite"></span>Add Events</a></li>
        <li><a  class="sub-ex" href="view-events.php"><span class="sprite"></span>View Events</a></li>
    </ul>
    </div>
  </div>
</section>

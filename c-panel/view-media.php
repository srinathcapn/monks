...
else
{
    ...
    $per_page = 10;
    $sql = "SELECT count(media_id) FROM media where delete_flag=0 ";
                ...
                <?php
                    echo '<table class="table">
                            <thead>
                                <tr>
                                    <th width="11%">S.No</th>
                                    <th width="31%">Media Title</th>
                                    <th width="31%">Media Image</th>
                        ...
                        for ($i = $start; $i < $end; $i++) 
                        {
                            ...
                            echo'
                                <td>'.($i + 1).'</td>
                                <td>'.$details[$i]['media_title'].'</td>
                                <td><img class="img_size" src="'.$details[$i]['media_image'].'"></td>
                                <td>'.$seo_title.'</td>';      
                            echo '<td class="button-holder"><a href=add-media.php?edit_id='.$details[$i]['media_id'].'>Edit</a></td>
                                <td class="button-holder"><a class="del_class_media" href="javascript:;" id='.$details[$i]['media_id'].'>Delete</a></td>
                            </tr>';
                        }
                        echo '</tbody>
                    </table>';
